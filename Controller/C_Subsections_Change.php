    ...
    protected function OnInput()
    {
        ...
        if ($this->IsPost()) {
            ...
            if ($_GET['id'] != '' || isset($_POST['save_close'])) {
                header("Location: /kadmin/?t=" . $this->table . "&c=select&sect=" . (int)$_GET['sect'] . "&page=1");
            } else {
                header("Location: /kadmin/?t=" . $this->table . "&c=change&sect=" . (int)$_GET['sect'] . "&id=" . $this->Subsection['id']);
            }
        }
