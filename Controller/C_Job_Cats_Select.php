...
// конттроллер сторінки всіх JobCats
class C_Job_Cats_Select extends C_Base
{
	public $JobCats;
	...
	// pagination
		...
		$this->JobCats = $object->Array_where($this->table, $this->where." ".$this->order." ".$this->limit);
		//форматуємо url по шаблону
		foreach ($this->JobCats  as &$g_c) {
