<aside class="<?= ($_COOKIE['menu_status'] == 'active') ? "active" : ""?>">
    ...
    <a href='/admin' class='logo'><?php include('View/blocks/svg/logo_primary.php'); ?></a>
                ...
                <li><a href='' class='has_submenu'>
                    ...
                    <ul>
                        ...
                        <?php if (constant('PRODUCT_CATS')) : ?>
                            <li data-menu-name="product_cats"><a href='/admin/?t=product_cats&c=select&page=1'><?php if(PRODUCT_CATS == 1){echo 'Категории';}else{echo PRODUCT_CATS;} ?></a></li>
                        <?php endif;?>
...
<!--                        --><?php //endif;?>
                        ...
                        <li data-menu-name="products"><a href='/admin/?t=products&c=select&page=1'>Продукты</a></li>

                        <?php if (constant('ORDERS')) : ?>
                            <li data-menu-name="orders"><a href='/admin/?t=orders&c=select&page=1'><?php if(ORDERS == 1){echo 'Заказы';}else{echo ORDERS;} ?></a></li>
                        <?php endif;?>
                        <?php if (constant('CUSTOMERS')) : ?>
                            <li data-menu-name="customers"><a href='/admin/?t=customers&c=select&page=1'><?php if(CUSTOMERS == 1){echo 'Клиенты';}else{echo CUSTOMERS;} ?></a></li>
                        <?php endif;?>
                    </ul>
                </li>
                <?php endif;?>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <?php if (constant('GALLERY_CATS')) : ?>
                            <li data-menu-name="gallery_cats"><a href='/admin/?t=gallery_cats&c=select&page=1'><?php if(GALLERY_CATS == 1){echo 'Категории Галерей';}else{echo GALLERY_CATS;} ?></a></li>
                        <?php endif;?>
                        <?php if (constant('GALLERIES')) : ?>
                            <li data-menu-name="galleries"><a href='/admin/?t=galleries&c=select&page=1'><?php if(GALLERIES == 1){echo 'Галереи';}else{echo GALLERIES;} ?></a></li>
                        <?php endif?>
                    </ul>
                </li>
                <?php endif;?>
                ...
                <li><a href='' class='has_submenu'>
                    ...
                    <ul>
                        ...
                        <?php if (constant('ARTICLE_CATS')) : ?>
                            <li data-menu-name="article_cats"><a href='/admin/?t=article_cats&c=select&page=1'><?php if(ARTICLE_CATS == 1){echo 'Категории Блога';}else{echo ARTICLE_CATS;} ?></a></li>
                        <?php endif;?>
                        <?php if (constant('ARTICLE_TAGS')) : ?>
                            <li data-menu-name="article_tags"><a href='/admin/?t=article_tags&c=select&page=1'><?php if(ARTICLE_TAGS == 1){echo 'Теги';}else{echo ARTICLE_TAGS;} ?></a></li>
                        <?php endif;?>
                        <?php if (constant('ARTICLE_COMMENTS')) : ?>
                            <li data-menu-name="article_comments"><a href='/admin/?t=article_comments&c=select&page=1'>Комментарии</a></li>
                        <?php endif;?>

                        <?php if (constant('ARTICLES')) : ?>
                                    <li data-menu-name="articles"><a href='/admin/?t=articles&c=select&page=1' class=""><?php if(ARTICLES == 1){echo 'Статьи Блога';}else{echo ARTICLES;} ?></a>
                        <?php endif?>
                    </ul>
                </li>
                <?php endif;?>
                ...
                <li><a href='' class='has_submenu'>
                    ...
                    <ul>
                        ...
                        <?php if (constant('NEWS')):?>
                            <li data-menu-name="news"><a href='/admin/?t=news&c=select&page=1'><?php if(NEWS == 1){echo 'Новости';}else{echo NEWS;} ?></a></li>
                        <?php endif;?>
                        <?php if (constant('TESTIMONIALS')):?>
                            <li data-menu-name="testimonials"><a href='/admin/?t=testimonials&c=select&page=1'><?php if(TESTIMONIALS == 1){echo 'Отзывы';}else{echo TESTIMONIALS;} ?></a></li>
                        <?php endif;?>
                            ...
                            <li><a href='' class='has_submenu'>
                                ...
                                <ul>
                                    <?php if (constant('BANNER_1')):?>
                                        <li data-menu-name="banner_1"><a href="/admin/?t=banner_1&c=select&page=1"><?php if(BANNER_1 == 1){echo 'Баннер 1';}else{echo BANNER_1;} ?></a></li>
                                    <?php endif?>
                                    <?php if (constant('BANNER_2')):?>
                                        <li data-menu-name="banner_2"><a href="/admin/?t=banner_2&c=select&page=1"><?php if(BANNER_2 == 1){echo 'Баннер 2';}else{echo BANNER_2;} ?></a></li>
                                    <?php endif?>
                                    <?php if (constant('BANNER_3')):?>
                                        <li data-menu-name="banner_3"><a href="/admin/?t=banner_3&c=select&page=1"><?php if(BANNER_3 == 1){echo 'Баннер 3';}else{echo BANNER_3;} ?></a></li>
                                    <?php endif?>
                                </ul>
                            </li>
                        <?php endif;?>
                        <?php if (constant('SLIDER_1') || constant('SLIDER_2') || constant('SLIDER_3')):?>
                            <li><a href='' class='has_submenu'>
                                ...
                                <ul>
                                    ...
                                    <li data-menu-name="slider_1"><a href="/admin/?t=slider_1&c=select&page=1"><?php if(SLIDER_1 == 1){echo 'Слайдер 1';}else{echo SLIDER_1;} ?></a></li>
                                    <?php endif?>
                                    <?php if (constant('SLIDER_2')):?>
                                        <li data-menu-name="slider_2"><a href="/admin/?t=slider_2&c=select&page=1"><?php if(SLIDER_2 == 1){echo 'Слайдер 2';}else{echo SLIDER_2;} ?></a></li>
                                    <?php endif?>
                                    <?php if (constant('SLIDER_3')):?>
                                        <li data-menu-name="slider_3"><a href="/admin/?t=slider_3&c=select&page=1"><?php if(SLIDER_3 == 1){echo 'Слайдер 3';}else{echo SLIDER_3;} ?></a></li>
                                    <?php endif?>
                                </ul>
                            </li>
                        <?php endif;?>
                        ...
                        <?php if (constant('MEDIA')):?>
                            <li data-menu-name="media"><a href='/admin/?t=media&c=select&page=1'><?php if(MEDIA == 1){echo 'Медиа';}else{echo MEDIA;} ?></a></li>
                        <?php endif;?>
                        ...
                        <?php if (constant('SUBSCRIBERS')):?>
                            <li data-menu-name="subscribers"><a href='/admin/?t=subscribers&c=select&page=1'><?php if(SUBSCRIBERS == 1){echo 'Подписчики';}else{echo SUBSCRIBERS;} ?></a></li>
                        <?php endif;?>
