...
<section data-sfield-name="" data-sfield-value="" data-table-has-url="1" data-up-level-id="<?=$_GET['sect']?>" data-table-name="<?=$table?>">
    <div class="underlined h2">
        <span data-showed-table-name="">Команда</span>
        <div class="per_page">
    ...
    <div class="row">
        <div class="row || col_9">
            <div class="col_8">
				...
				<a class="button || outline" href="/admin/?t=<?=$table?>&c=change<?=$cat?>">Добавить</a>
				<? } ?>
            </div>
        </div>
    </div>
    ...
    <table class="table || checkbox_table" data-table-name="<?=$table?>"
        ...
        <?php $i=0; foreach($teams as $team):?>
            <tr id="tr<?=++$i;?>" data-field-id="<?=$team['id']?>">
                <td class="tc" width="40">
                    <div class="row">
                ...
                <td class="tc"><?=$team['id']?></td>
                <td class="tc"><?=$team['name']?></td>
                <td class="tc">
                    <a href="/admin/?t=<?=$table?>&c=change&id=<?=$team['id']?>" class="link_icon">
