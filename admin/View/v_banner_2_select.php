    ...
    <table class="table || checkbox_table" data-table-name="<?=$table?>"
        ...
        <?php $i=0; foreach($banner_2 as $banner):?>
            <tr id="tr<?=++$i;?>" data-field-id="<?=$banner['id']?>">
                ...
                <td class="tc"><img src="/admin/image.php?width=80&height=80&cropratio=1:1&image=/pictures/<?=$table?>/<?=$banner['image1']?>" alt="<?=$banner['name']?>"></td>
                <td class="tc">
                    <a href="/admin/?t=<?=$table?>&c=change&id=<?=$banner['id']?>" class="link_icon">
