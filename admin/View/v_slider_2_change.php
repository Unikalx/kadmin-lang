                ...
                <div class="row">
                    <?php if($settings['image1']['on_off']):?>
                        ...
                        <div class="col_6 upload_file">
                            <!--file-->
                            <div data-table="<?=$table?>" data-field="image1" data-<?=$table . '_image1'?> class='pre_input' data-image-url="/pictures/<?=$table?>/<?=$columns['image1']?>"><?=$settings['image1']['field_title'] ? $settings['image1']['field_title'] : "image1";?>
                    ...
                    <?php if($settings['image2']['on_off']):?>
                        ...
                        <div class="col_6 upload_file">
                            <!--file-->
                            <div data-table="<?=$table?>" data-field="image2" data-<?=$table . '_image2'?> class='pre_input' data-image-url="/pictures/<?=$table?>/<?=$columns['image2']?>"><?=$settings['image2']['field_title'] ? $settings['image2']['field_title'] : "image2";?>
                                <span title='Удалить' class='delete_thumbnail'><svg class='icon'><use xlink:href='View/img/svgdefs.svg#icon_trash'></use></svg></span>
                                <span title='Показать изображение' class='watch_thumbnail'><svg class='icon'><use xlink:href='View/img/svgdefs.svg#icon_eye'></use></svg></span>
                            </div>
