...
// конттроллер сторінки всіх Testimonials
class C_Testimonials_Select extends C_Base
{
	public $Testimonials;
	...
	// виводимо секції
		...
		$this->Testimonials = $object->Array_where($this->table, $this->where." ".$this->order." ".$this->limit);
	}
