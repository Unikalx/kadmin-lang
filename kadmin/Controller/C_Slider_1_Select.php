...
class C_Slider_1_Select extends C_Base
{
	public $Slider_1;
	...
	// виводимо секції
        ...
        $this->Slider_1 = $object->Array_clean("Select s_1.id,s_1.image1,s_1.checkbox,s_1T.name FROM slider_1 as s_1 JOIN slider_1Translate as s_1T on s_1T.id_slider_1 = s_1.id WHERE s_1T.lang='".ADMIN_LANG."' $this->and $this->where GROUP by s_1T.id_slider_1 $this->order $this->limit");
