...
// конттроллер сторінки всіх Subscribers
class C_Subscribers_Select extends C_Base
{
	public $Subscribers;
	...
	// виводимо секції
		...
		$this->Subscribers = $object->Array_where($this->table, $this->where.' '.$this->order." ".$this->limit);
	}
