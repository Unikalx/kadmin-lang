...
<div class="wrapper">
    <div class="wrapper" data-table-name="<?= $table ?>" data-up-level-id="<?= $columns['id_sect'] ?>">
        <form data-edit-create="<?= $table ?>" action="" method="POST"
            ...
            <section>
                <span class="h1"><?= $_GET['id'] ? 'редактирование' : 'добавление'; ?> категорию продуктов
            </span>
                <div class="row">
                    <?php if ($settings['parent_id']['on_off']): ?>
                        <div class="col_6">
                            ...
                            <select name='<?= $table ?>[parent_id]'
                                    class="input <?= $settings['parent_id']['field_style'] ? $settings['parent_id']['field_style'] : "" ?>">
                ...
                <div class="row">
                    <?php if ($settings['has_child']['on_off']): ?>
                        <div class="col_6">
                            ...
                            <select name='<?= $table ?>[has_child]'
                                    class="input <?= $settings['has_child']['field_style'] ? $settings['has_child']['field_style'] : "" ?>">
                    ...
                    <?php if ($settings['checkbox']['on_off']): ?>
                        <div class="col_6" style="margin-top: 3rem;">
                            <input class="<?= $settings['checkbox']['field_style'] ? $settings['checkbox']['field_style'] : "" ?>"
                                   value=1" name='<?= $table ?>[checkbox]' type='checkbox'
                ...
                <div class="row">
                    ...
                    <!--<div class="col_4">
                        ...
                        <div class='pre_input'>Choose Gallery</div>
                        <select name="<?/*= $table */?>[gallery_id]" class="input">
                            <option value="0">No Gallery</option>
                            <?/* foreach ($galleries as $gallery): */?>
                                <option value="<?/*= $gallery['id'] */?>" <?/* if ($gallery['id'] == $columns['gallery_id']) echo "selected"; */?>><?/*= $gallery['name'] */?></option>
                            <?/* endforeach */?>
                        </select>
                    </div>-->
                </div>
                ...
                <div langSections="ua">
                    <?php if ($settingsTranslate['name']['on_off'] OR !isset($_GET['id'])): ?>
                        <div class="row">
                            <div class="col_6">
                                <div class="pre_input"><?= $settingsTranslate['name']['field_title'] ? $settingsTranslate['name']['field_title'] : "Имя Категории" ?>
                                    UA
                                </div>
