...
<body style='overflow-y: scroll'>
	...
	<form action='' method="POST" class='login_form || validate_form'>
		...
		<div class='input_wrap'><svg class='icon'><use xlink:href='View/img/svgdefs.svg#icon_person'></use></svg><input type='text' name='login' placeholder='Логин для входа' class='input || validate'></div>
		<div class='input_wrap'><svg class='icon'><use xlink:href='View/img/svgdefs.svg#icon_key'></use></svg><input type='password' name='password' placeholder='Ваш пароль' class='input || validate'></div>
