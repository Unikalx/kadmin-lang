...
<div class="wrapper">
    <div class="wrapper" data-table-name="<?= $table ?>" data-up-level-id="<?= $columns['id_sect'] ?>">
        <form data-edit-create="<?= $table ?>" action="" method="POST"
            ...
            <section>
                <span class="h1"><?= $_GET['id'] ? 'редактирование' : 'добавление'; ?> ПОДСЕКЦИИ
            </span>
                <div class="row">
                    <div class="col_6">
                        <div class="row">
                            <?php if ($settings['id_sect']['on_off']): ?>
                                <div class="col_8">
                                    ...
                                    <select name='<?= $table ?>[id_sect]'
                                            class="input <?= $settings['id_sect']['field_style'] ?>">
                                        <option value="0" style="display: none;" selected>Select</option>
                                        <?php foreach ($sections as $sect): ?>
                                            <option value="<?= $sect['id'] ?>" <?= ($sect['id'] == $columns['id_sect'] || $sect['id'] == $_GET['sect']) ? 'selected' : '' ?>><?= $sect['nameT'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            <?php endif; ?>
                ...
                <?php if ($settings['value1']['on_off']): ?>
                    <div class="row <?= $settings['value1']['on_off'] ? "" : "none" ?>">
                        ...
                        <textarea <?= ($settings['value1']['field_style'] != 'ckeditor' ? "class='" . $settings['value1']['field_style'] . "'" : "data-ckeditor id='" . $table . "_value1'") ?>
                                name="<?= $table ?>[value1]"><?= $columns['value1'] ?></textarea>
                    </div>
                <?php endif; ?>
                <?php if ($settings['value2']['on_off']): ?>
                    <div class="row">
                        ...
                        <textarea <?= ($settings['value2']['field_style'] != 'ckeditor' ? "class='" . $settings['value2']['field_style'] . "'" : "data-ckeditor id='" . $table . "_value2'") ?>
                                name="<?= $table ?>[value2]"><?= $columns['value2'] ?></textarea>
                    </div>
                <?php endif; ?>
                <?php if ($settings['value3']['on_off']): ?>
                    <div class="row <?= $settings['value3']['on_off'] ? "" : "none" ?>">
                        ...
                        <textarea <?= ($settings['value3']['field_style'] != 'ckeditor' ? "class='" . $settings['value3']['field_style'] . "'" : "data-ckeditor id='" . $table . "_value3'") ?>
                                name="<?= $table ?>[value3]"><?= $columns['value3'] ?></textarea>
                    </div>
                <?php endif; ?>
                <div class="row">
                    <?php if ($settings['field_1']['on_off'] AND $_GET['sect'] != 96): ?>
                        <div class="col_6">
